...
type: SFG
status: "complet — deux intentions validées, une restée en hypothèse"
module: billing
domaine: "Facturation"
audience: "Comptables et gestionnaires qui reçoivent, contestent ou relancent les factures"
unite_evolution: "cas d'usage"
version: "atlas-2026.09"
generated_at: "2026-09-08"
generated_by: "sonnet — rendu depuis la SFD figée ; aucune lecture du code ni du graphe"
derives_from: ["sfd/facturation.md"]
last_code_sync: "a1b2c3d"
confidence: H
unit: use_case
unit_ref: CU-01
frozen_at: "2026-09-08T16:30:00Z"
---

> **Documentation générée par DMAD** · run `atlas-2026-09-07-01` · commit `a1b2c3d`
> **Document :** SFG — domaine `Facturation`, deux cas d'usage
> **Dérive de :** [`sfd/facturation.md`](../sfd/facturation.md) figée
> **Confiance globale : H** sur les intentions · les faits sont en `V` et `I`
...
## CU-01 — Facturer les livraisons de la nuit
...
| Règle | Section SFD |
|---|---|
| RG-001 | [`sfd/facturation.md`](../sfd/facturation.md) § 4 — N2, opérations de contrôle |
| RG-002 | [`sfd/facturation.md`](../sfd/facturation.md) § 6 — N0, opérations de traitement · `BR-FACT-021` |
| RG-003 | [`sfd/facturation.md`](../sfd/facturation.md) § 5 — N1, données de contrôle · `BR-FACT-014` |

---

## CU-02 — Refacturer une livraison à la demande
...
| Règle | Section SFD |
|---|---|
| RG-004 | [`sfd/facturation.md`](../sfd/facturation.md) § 5 — N1, opérations de contrôle · `OQ-019` |
