...
description: Le montant de chaque ligne de facture est calculé avec une précision
  ...
  L'affichage et l'export comptab…
id: BR-FACT-021
...
evidence:
- kind: code
  ref: src/billing/AmountCalculator.java#L88-L140
  commit: a1b2c3d
  tool: jcallgraph.definition
- kind: schema
  ref: invoice_lines.amount DECIMAL(12,4)
  tool: schema.columns
- kind: test
  ref: src/test/characterization/AmountCalculatorCharacterizationTest.java#L22-L58
  outcome: passing
  tool: maven.test
- kind: code
  ref: src/accounting/export/CsvWriter.java#L61
  tool: jcallgraph.callers
intent:
  statement: 'La précision à 4 décimales daterait de la reprise des contrats au pourcentage
    (2017), où l''arrondi à 2 provoquait des écarts cumulés sur les gros volumes.
  ...
  - kind: commit
    ref: 4d5e6f7
    note: '2017-06-02 — feat(billing): increase amount scale to 4 (contrats %)'
  competing_hypotheses:
  - choix technique par défaut jamais questionné
  validated_by: null
  question: OQ-013
relates_to:
- UC-FACT-003
