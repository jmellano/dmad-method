...
description: Le module src/billing est le 3e hotspot du dépôt (churn x complexité)
  et 87 % de ses lignes sont attribuées à un unique contributeur, parti en 2023. Son
  bus factor est de 1.
id: RISK-FACT-001
...
- kind: code
  ...
  commit: a1b2c3d
  tool: git.churn
  note: 412 modifications sur 24 mois, rang 3/20
- kind: code
  ref: src/billing/
  tool: git.shortlog
  note: 87 % des lignes attribuées à un contributeur unique
- kind: absence
  ref: git shortlog --since=2023-06
  note: aucune contribution de cet auteur depuis juin 2023
relates_to:
- BR-FACT-021
- BR-FACT-014
