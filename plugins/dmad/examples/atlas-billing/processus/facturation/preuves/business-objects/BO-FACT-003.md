...
id: BO-FACT-003
functional_name: Ligne valorisée
...
- kind: contract
  ...
  availability: ad-hoc
  in_loop: true
  cardinality: un appel par ligne de commande — jusqu'à 40 par facture
confidence: I
...
- appelle le contrat : [CTR-FACT-002](../contrats/CTR-FACT-002.md)
